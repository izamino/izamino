...
<section class="section section--tight" id="loop">
	<div class="wrap">
		...
		<div class="loop" data-stagger="70">
			<?php foreach ( madar_demo( 'loop' ) as $madar_step ) : ?>
				<div class="loop__item" data-anim="up">
					<span aria-hidden="true"><?php echo esc_html( $madar_step[2] ); ?></span>
					<?php echo esc_html( $madar_step[0] ); ?>
					<small><?php echo esc_html( $madar_step[1] ); ?></small>
				</div>
			<?php endforeach; ?>
		</div>
		...
		<div class="pill-row" style="justify-content:center;margin-top:30px" data-anim="up">
			...
			<span class="chip chip--violet"><?php esc_html_e( 'ماهر', 'madar' ); ?></span>
