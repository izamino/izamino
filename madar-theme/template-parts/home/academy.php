...
<section class="section" id="academy">
	<div class="wrap">
		<div class="s-head reveal">
			...
			<p><?php esc_html_e( 'هر دوره چند جلسه کوتاه است، با یک خروجی واقعی و XP مشخص که در پرونده رشد دانش‌آموز ثبت می‌شود.', 'madar' ); ?></p>
		</div>
				...
				<?php foreach ( madar_demo( 'courses' ) as $madar_demo_item ) : ?>
					<article class="card card--media reveal">
						...
						<div class="card__body">
							...
							<p><?php echo esc_html( $madar_demo_item[3] ); ?><br><?php echo esc_html( $madar_demo_item[4] ); ?></p>
							<div class="card__foot">
